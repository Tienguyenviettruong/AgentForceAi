...
filepath = "src/application/orchestration/executor.rs"
with open(filepath, 'r') as f:
    content = f.read()

# We need to inject Tool Schema into the system prompt and append RAG memory.
# In `execute_task`:
# Before `while iteration < max_iterations`, we can get the system prompt and append our injection.
