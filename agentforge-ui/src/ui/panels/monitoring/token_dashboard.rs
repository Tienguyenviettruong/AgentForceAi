...
fn render_token_bar_chart(
    title: &str,
    data: &[(String, usize)],
    cx: &Context<TokenDashboard>,
) -> impl IntoElement {
    let theme = cx.theme().clone();
    let max_value = data.iter().map(|(_, value)| *value).max().unwrap_or(0) as f32;
    let mut bars = h_flex().items_end().gap_2().h(gpui::px(150.)).w_full();
    ...
    if data.is_empty() {
        ...
        for (label, value) in data.iter().take(8) {
            let height = if max_value > 0.0 {
                ((*value as f32 / max_value) * 120.0).max(6.0)
            } else {
                6.0
            };
            bars = bars.child(
                v_flex()
                    ...
                    .child(
                        div()
                            .text_xs()
                            .text_color(theme.muted_foreground)
                            .child(label.chars().take(10).collect::<String>()),
                    ),
            );
        }
    }
            ...
            agent_list = agent_list.child(
                h_flex()
                    ...
                    .child(
                        div()
                            .font_bold()
                            .child(format!("{} tokens", format_tokens(*tokens))),
                    ),
            );
        }
        ...
        v_flex()
                        ...
                        v_flex()
                            ...
                            .child(
                                div()
                                    .text_2xl()
                                    .font_bold()
                                    .child(format_tokens(self.daily_tokens))
                                    .mt_2(),
                            )
                            .child(
                                div()
                        ...
                        v_flex()
                            ...
                            .child(
                                div()
                                    .text_sm()
                                    .text_color(theme.muted_foreground)
                                    .child("Active Instances"),
                            )
                            .child(
                                div()
                                    .text_2xl()
                                    .font_bold()
                                    .child(self.tokens_per_instance.len().to_string())
                                    .mt_2(),
                            )
                            .child(
                                div()
            ...
            .child(
                h_flex()
                    .w_full()
                    .gap_4()
                    .child(div().flex_1().child(render_token_bar_chart(
                        "Tokens by Agent",
                        ...
                        v_flex()
                            ...
                            .child(
                                div()
                                    .font_bold()
                                    .text_lg()
                                    .child("Agent Participation (Instances)"),
                            )
