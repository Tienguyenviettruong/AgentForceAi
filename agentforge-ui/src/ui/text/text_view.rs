...
use gpui::{
    div, AnyElement, App, Bounds, Element, ElementId, Entity, GlobalElementId, Hitbox,
    HitboxBehavior, InspectorElementId, InteractiveElement, IntoElement, LayoutId, MouseDownEvent,
    MouseMoveEvent, MouseUpEvent, ParentElement, Pixels, SharedString, StyleRefinement, Styled,
    Window,
};

use crate::ui::text::global_state::GlobalState;
use crate::ui::text::node::CodeBlock;
use crate::ui::text::state::TextViewState;
use crate::ui::text::TextViewFormat;
use crate::ui::text::TextViewStyle;
...
mod tests {
    use super::TextView;
    use crate::ui::text::TextViewState;
    use gpui::{
        div, point, px, AppContext as _, Context, Entity, IntoElement, Modifiers, MouseButton,
