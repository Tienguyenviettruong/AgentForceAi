...
impl TeamService {
    ...
    pub fn get_team_agents(
        &self,
        team_id: &str,
    ) -> Result<Vec<Agent>, crate::core::errors::CoreError> {
        let agent_ids = self
            .db
    ...
    pub fn list_sessions_for_instance(
        &self,
        instance_id: &str,
    ) -> Result<Vec<SessionRecord>, crate::core::errors::CoreError> {
        self.db
            .list_sessions_for_instance(instance_id)
            .map_err(|e| crate::core::errors::CoreError::Database(e.to_string()))
    }

    pub fn get_instance_agents(
        &self,
        instance_id: &str,
    ) -> Result<Vec<String>, crate::core::errors::CoreError> {
        self.db
            .get_instance_agents(instance_id)
            .map_err(|e| crate::core::errors::CoreError::Database(e.to_string()))
    }

    pub fn create_session_for_instance(
        &self,
        instance_id: &str,
        agent_id: &str,
    ) -> Result<String, crate::core::errors::CoreError> {
        self.db
